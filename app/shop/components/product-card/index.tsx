  ...
  return (
    <div className="relative w-full aspect-[3/4] md:aspect-square bg-muted group overflow-hidden">
      ...
      >
        ...
        {/* Title bar — visible by default, hides on hover */}
        <div className="absolute top-0 inset-x-0 p-3 flex gap-6 justify-between items-baseline font-semibold transition-all duration-300 max-md:hidden group-hover:opacity-0 group-hover:-translate-y-full">
      ...
      {/* Bottom panel — appears on hover, pointer-events only when visible */}
      <div className="absolute inset-x-3 bottom-3 flex flex-col gap-8 px-2 py-3 rounded-md transition-all duration-300 pointer-events-none bg-popover opacity-0 translate-y-1/3 group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto">
