            ...
            >
              <div className="flex flex-col p-3 w-full rounded bg-muted md:p-4">
                <div className="flex justify-between items-baseline pl-2 mb-10">
                  <p className="text-2xl font-semibold">Menú</p>
                  <Button size="sm" variant="ghost" aria-label="Cerrar carrito" onClick={closeMobileMenu}>
                    Cerrar
                  </Button>
                </div>
                ...
                <ShopLinks label="Categorías" collections={collections} />
